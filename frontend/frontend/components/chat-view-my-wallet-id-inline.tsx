...
/** Meine Kontakt-ID + Peering-QR (rechts oben im Chat-Kopf). */
...
export function ChatViewMyWalletIdInline(p: ChatViewMyWalletIdInlineProps) {
  ...
  return (
    <div className="flex w-full min-w-0 flex-col gap-2 border-t border-border/50 pt-1.5 sm:w-auto sm:min-w-[14rem]">
