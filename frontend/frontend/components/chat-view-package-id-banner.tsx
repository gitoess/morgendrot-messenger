  ...
  return (
    ...
    >
      <div className="min-w-0 flex-1 space-y-0.5">
        <p className="font-medium text-sky-950 dark:text-sky-100">New protocol version available</p>
        <p className="font-mono text-[11px] text-foreground/90" title={serverPackageId}>
          {short}
        </p>
      </div>
      <button
