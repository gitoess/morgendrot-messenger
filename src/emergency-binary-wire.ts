 ...
 * Spiegel von `lora-bridge/src/emergency-binary.ts` (bei Änderungen beide Dateien angleichen).
 *
 * Layout:
 * [0]     uint8  version = 2
...
import { EmergencyBinaryWireVersionByte } from './shared/opcodes.js';

/** Einzige Quelle des Versions-Bytes: `src/shared/opcodes.ts` */
