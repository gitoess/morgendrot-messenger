...
4. **Nächste Scheiben:** PWA-**UI** zu Drain/Backoff/Fehler + Dedup/Reject im Sendepfad (**2026-03-28**); optional weiter verfeinern (**Backoff/Defer** **`docs/SYNC-SOURCE-OF-TRUTH-UND-KONFLIKTE.md`** § 8.1); **`messageNonceU64`** dort einsetzen, wo der Client den Nonce aus dem Wire kennt (bereits im Outbox-Pfad).  
