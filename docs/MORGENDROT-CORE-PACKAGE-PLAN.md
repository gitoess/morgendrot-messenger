...
4. **Nächste Scheiben:** Retry-/Konflikt-Politik verfeinern (**Backoff/Defer** dokumentiert unter **`docs/SYNC-SOURCE-OF-TRUTH-UND-KONFLIKTE.md`** § 8.1); optional **`messageNonceU64`** aus dem Mailbox-/E2E-Protokoll durchreichen, sobald der Client den Nonce kennt.  
