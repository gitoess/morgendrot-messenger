...
**Next-PWA (§ H.3g Paket 6):** Einstellungen → **Einsatz-Rollen-Vorlagen** — UI **`frontend/frontend/components/views/settings-view.tsx`**, Client **`frontend/frontend/lib/api/einsatz-role-templates.ts`**. **Fahrplan:** **`docs/ROADMAP-FAHRPLAN.md`** § **H.3g** (Pakete **2**/**6**), Ausführungsreihenfolge **§ C.0b** Stufe **3**.
