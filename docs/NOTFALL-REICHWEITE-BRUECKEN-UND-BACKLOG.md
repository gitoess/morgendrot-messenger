...
**Technik LoRa ↔ IOTA:** **`docs/LORA-IOTA-NOTFALL-GATEWAY-REALITAET.md`** (**Fahrplan § H.3m**) — keine volle TX über Funk; Gateway/Delayed Upload. **SOS-Wire Zielbild:** **`docs/MORG-EMERGENCY-SOS-WIRE-SPEC.md`** (**§ H.3n**).
