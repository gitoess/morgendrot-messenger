...
- **Phase 2 (mittelfristig, Ticket A):** Audio-Chunking als separates Funkprotokoll (`transferId`, `chunkIndex`, ACK/Bitmap, Reassembly-Buffer, Retry/Timeout). Airtime-Risiko explizit beachten (mehrsekündige Memo kann Mesh deutlich blockieren); für priorisierte Sprachsendung bleibt **Mesh v2 Burst** Leitplanke.
