...
**Aktuell sinnvolle „nächste drei“ konkrete Arbeiten (Stand Doku 2026-04-28):** (1) **§ H.15** — **Stufe 4** (Relay optional: beide Modi im **`TESTING.md`**-Ritual verankern) **und** Stufe **2** mindestens **einmal** nach **`docs/HANDY-FIRST-STAGE2-CLIENT-SUBMIT-SMOKE.md`** auf Testnet verifizieren (Digest/Fehlerpfad). (2) **§ H.15** — **Stufe 3** vertiefen: Retry-/Konflikt-Politik Outbox (**`MORGENDROT-CORE-PACKAGE-PLAN.md`** Scheibe 4) unter **§ H.12** weiterdenken — **kein** zweiter Settlement-Pfad. (3) **§ H.1b** — nächste **kleine** UI-Modularitäts-Scheibe — **nicht** parallel großer Mesh-Kern. **PWA-Schreibtisch (§ C.0b Stufe 0 / § H.2):** Protokollzeile **2026-04-28** in **`docs/PWA-MANUAL-CHECKS.md`** — nach Deploy **`check:pwa-desk`** / bei Release **`check:pwa-desk:full`**; **L1–L5** am Gerät. **Kürzlich dokumentiert:** **2026-04-28** neue Primärleitlinie **`docs/BACKEND-VS-DIREKT-IOTA-ERKLAERUNG.md`** § 6 + **`docs/ARCHITECTURE-HANDY-FIRST-CLIENT-IOTA.md`** + **§ H.15**. **Paket 7 voll** (Offline-Relay / Settlement) erst mit **§ H.12** / Phase B — **Paket 7a** bleibt **Vorbereitung**. **Phase B:** Spec **`docs/MORG-EMERGENCY-SOS-WIRE-SPEC.md`** (**§ H.3n**) vor größeren Eingriffen mit **`emergency-binary-wire.ts`** und **`LORA-IOTA-DELAYED-UPLOAD-SPEC`** abgleichen.

**Nachtrag 2026-04-28 (Reihenfolge Stufe 2 → 3 → H.0 → H.2 umgesetzt):** Stufe **0–1** unverändert Basis; **Stufe 2** = Smoke-Doku + Vitest; **Stufe 3** = **`docs/SYNC-SOURCE-OF-TRUTH-UND-KONFLIKTE.md`** § 8 + Adapter-Kommentar **`offline-queue.ts`**; **H.0** = Einstellungen **Wallet & Session**; **H.2** = Handbuch **`sw-6`**, zwei neue **`/handbook/*.md`**, Protokoll **`PWA-MANUAL-CHECKS`**. Details **`CHANGELOG.md`** [Unreleased], **`docs/OPERATIONS-SNAPSHOT-2026-03.md`** (Nachtrag 2026-04-28).
