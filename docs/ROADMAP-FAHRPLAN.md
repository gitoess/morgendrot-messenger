...
**Aktuell sinnvolle „nächsten drei“ nach § C.0b (Schreibtisch zuerst; Stand Doku 2026-03-28):** (1) **§ H.15 Stufe 4** — Ritual **`npm run test:h15-direct-submit`** + **`TESTING.md`** Zeile **5c** (Digest/Fehlerpfad am Schreibtisch). (2) **§ H.15 Stufe 3** — **Ist (2026-03-28):** Outbox-/Konflikt-**UI** wie zuvor beschrieben; vertiefende Konflikt-**UI** = Backlog. (3) **§ H.1b** — **Ist (2026-03-28–29):** send↔attachments-ESLint; Kachel-Whitelist (**§ H.17**) + Vitest. **Als Nächstes (ohne H.15-Stufe-2-Handy zuerst):** **§ H.2** / **`check:pwa-desk`**, **§ H.1a**, **`docs/MESSAGING-MAILBOX-SSOT-SPEC.md`** (Persistent/`forceLegacyPlaintext`-Folge, Tests), **§ H.3n**-Spec-Abgleich. **§ H.15 Stufe 2** (manuelles Smoke, **`docs/HANDY-FIRST-STAGE2-CLIENT-SUBMIT-SMOKE.md`**) **hinten anstellen** — **`docs/HANDY-TEST-WINDOW.md`**, gleiche Deploy-Version, **nach** den vorgenannten Scheiben. **Ergänzend erledigt (2026-03-28):** **§ H.3**-Vorlauf — Delayed-Mirror-Drain → Forensic **`mtx`**, LoRa/Tangle-**Persistenz**, Panel-Hinweise (**Nachtrag** unten bei **Betriebsrhythmus**). **Nächstes:** weitere **§ H.1a**-RTL-Slices oder kleine **`lib/`-Helfer** — **nicht** parallel großer Mesh-Kern. **PWA / § H.2:** nach Messenger-Änderungen **`check:pwa-desk`** / bei Release **`full`**; **L1–L5** + **installierte PWA** (Sperre im Hintergrund, Kachel-Wiederherstellung) am Gerät gegen **`docs/HANDY-TEST-WINDOW.md`** prüfen. **Kürzlich dokumentiert:** **2026-04-28** Primärleitlinie **`BACKEND-VS-DIREKT-IOTA-ERKLAERUNG.md`** § 6 + **`ARCHITECTURE-HANDY-FIRST-CLIENT-IOTA.md`**. **Paket 7 voll** erst mit **§ H.12** / Phase B — **Paket 7a** Vorbereitung. **Phase B:** **`MORG-EMERGENCY-SOS-WIRE-SPEC.md`** (**§ H.3n**) vor Mesh-Kern-Eingriffen mit Code abgleichen.
