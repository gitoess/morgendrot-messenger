...
Alle Funktionen nacheinander testen und abhaken. Voraussetzung: Move-Package deployed, `create_globals` ausgeführt, `.env` mit PACKAGE_ID, VAULT_REGISTRY_ID, MAILBOX_ID, MY_ADDRESS (und ggf. PARTNER_ADDRESS).
