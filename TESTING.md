...
3. **Optional (Chain / IOTA-CLI) — zwei verschiedene Realworld-Pfade:**  
   ...
   Wenn die **IOTA-CLI** und der **RPC-Server** unterschiedliche **API-Versionen** melden, schlagen Ticket/Key-Schritte fehl („Client/Server api version mismatch“); CLI an den RPC angleichen, dann erneut ausführen. Ersetzt **nicht** die Chain-freien Smoke-Tests oben.
