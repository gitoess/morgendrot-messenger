...
6. **`docs/HANDSHAKE-ANFRAGEN-UX.md`** — eingehende Handshake-Anfragen (Posteingang, Toast, Ablehnen); Roadmap **§ H.27**.
7. **`docs/KONTAKT-MAILBOX-VIER-SLOTS-ZIELBILD.md`** — Backlog: vier Ziel-Mailboxen pro Kontakt + Send-Auswahl (**§ H.22 M4e**).
